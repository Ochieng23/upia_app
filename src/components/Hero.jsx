...
export function Hero() {
  return (
    <Container
      className=" relative mt-10 py-20   pb-16 pt-20 text-center h-screen lg:pt-40   2xl:h-[calc(100vh-1000px)] 2xl:pt-60"
      style={{
    ...
    >
      ...
      {/* Overlay */}
      <div className="bg-white-400 sm:pt-30 relative z-10 pt-20 ">
